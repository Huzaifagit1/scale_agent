...
export const FORM_SECTIONS: Section[] = [
  {
    ...
    fields: [
      { key: 'pretensao_do_negocio', ghlId: '3yU7SZgRWPPY64qIAejI', label: 'Pretensão do negócio', type: 'CHECKBOX', options: ['Venda', 'Aluguel'] },
      { key: 'tipo_do_imovel', ghlId: 'ih9s4iEpVxFYaz1hdxfC', label: 'Tipo do imóvel', type: 'RADIO', options: ['Apartamento', 'Casa', 'Casa comercial', 'Chacara', 'Terreno', 'Sala', 'Salao', 'Ponto', 'Conjunto', 'Conj. comercial', 'Prédio comercial', 'Galpao', 'Galpão Industrial', 'Barracao', 'Armazem', 'Sitio', 'Fazenda', 'Haras', 'Flat', 'Kitnet', 'Duplex', 'Cobertura', 'Sobrado', 'Terreo(a)', 'Studio', 'Normal', 'Padrão'] },
      { key: 'categoria', ghlId: 'hkUd2nSwCOKCQGl0HBM7', label: 'Categoria', type: 'RADIO', options: ['Cobertura', 'Duplex', 'Flat', 'Kitnet', 'Sobrado', 'Terreo(a)', 'Normal', 'Padrão'] },
      ...
      { key: 'situacao', ghlId: 'ix8cozN35Zl1H3JvPa1C', label: 'Situação', type: 'RADIO', options: ['Ativo', 'Inativo', 'Vendido', 'Locado', 'Permutado', 'Em avaliação', 'Avaliado', 'Em validação', 'Suspenso'] },
      { key: 'referencia', ghlId: 'W5rMkS4725rkUH6YPfUW', label: 'Referência', type: 'TEXT' },
    ]
  },
  {
    id: 'localizacao',
    ...
    fields: [
      ...
      { key: 'endereco', ghlId: 'M2KLKYf5vJEQnkH9Mv9L', label: 'Endereço', type: 'TEXT' },
      { key: 'numero', ghlId: 'D2LQH6MUjQy11oU0GcFA', label: 'Número', type: 'NUMERICAL' },
      { key: 'complemento', ghlId: 'tZY4M1PavIQ2mfRVSpdM', label: 'Complemento', type: 'TEXT' },
      { key: 'bairro_commercial', ghlId: 'vOoCUqJ1Yh4JTkqyUhZH', label: 'Bairro', type: 'TEXT' },
      { key: 'bairro_oficial', ghlId: 'HakqR4XMZe4uP2LNpfw1', label: 'Bairro Oficial', type: 'TEXT' },
      ...
      { key: 'regiao', ghlId: 'Q2Sv6T5P640VbLgmnkeA', label: 'Região', type: 'TEXT' },
      { key: 'quadra', ghlId: '3Hb8YSAALYe2H5FV7uJg', label: 'Quadra', type: 'TEXT' },
      { key: 'lote', ghlId: '4MniFx7ORQ1XfxweZXnK', label: 'Lote', type: 'TEXT' },
      { key: 'ponto_de_referencia', ghlId: 'zmPvDpDgRln0qlIdycwe', label: 'Ponto de referência', type: 'TEXT' },
    ]
  },
  {
